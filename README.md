...
### ★ 電子書籍サービスにおける検索機能の改善【AWS/Elasticsearch】(2020年5月)

【プロジェクト概要】

電子書籍サービスにおける検索サービスを改善しました。書籍のタイトル・著者情報だけでなく、本文も含めた全体から特定の検索キーワードについて書かれた書籍を探し出します。

【担当業務】

元々 Elasticsearch を利用して検索機能が実装されていましたが、データスキーマの見直しやクエリの見直しを実施しました。既存のスキーマから新しいスキーマへのデータ変換スクリプトの作成や、本番環境におけるデータ移行作業も担当しました。
